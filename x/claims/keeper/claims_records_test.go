...
func (suite *KeeperTestSuite) TestsClaimsRecords() {
	addr1, err := sdk.AccAddressFromBech32("akkad1hf0468jjpe6m6vx38s97z2qqe8ldu0njhzq6kj")
	suite.Require().NoError(err)
	addr2, err := sdk.AccAddressFromBech32("akkad1sv9m0g7ycejwr3s369km58h5qe7xj77hk70r8k")
	suite.Require().NoError(err)
