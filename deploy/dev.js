...
const main = async function () {
  console.log(
    `validators:${argv.validators}, commonNode:${argv.commonNode}, init:${argv.init}, fixed:${argv.fixed}, compile:${argv.compile}, start:${argv.start}, stop:${argv.stop}, keep:${argv.keep}, nohup:${argv.nohup}\n`
  );
  ...
  try {
    ...
    if (init || isKeep) {
      ...
      const nodeKey = { priv_key: { type: 'tendermint/PrivKeyEd25519', value: 'xMf4B04XpFEEjEBDsco+kg2i9UhaJNmn/AeItcxVI8TtTToRRRHlS0jPHKnNEqie1a6Q7m4CThsV2HaT0Izn8Q==' } };
      const privValidatorConsensusKey = {
        address: 'AF5D57E3DBCCF60395279EFCA7ECD208AE919748',
        pub_key: {
          type: 'tendermint/PubKeyEd25519',
          value: 'YF21DVxMmEMFwz5iNWLnlR8LicCH5L7Go+OnRg/EiCs=',
        },
        priv_key: {
          type: 'tendermint/PrivKeyEd25519',
          value: 'h6ycULLoTyjdyZ35ztETz6YWyYH3o/zB3czyVDYS+8ZgXbUNXEyYQwXDPmI1YueVHwuJwIfkvsaj46dGD8SIKw==',
        },
      };
      const createValidator = {
          ...
          messages: [
            {
              ...
              delegator_address: 'akkad1hajh6rhhkjqkwet6wqld3lgx8ur4y3khg60k63',
              validator_address: 'akkadvaloper1hajh6rhhkjqkwet6wqld3lgx8ur4y3khyju2rc',
              pubkey: { '@type': '/cosmos.crypto.ed25519.PubKey', key: 'YF21DVxMmEMFwz5iNWLnlR8LicCH5L7Go+OnRg/EiCs=' },
              value: { denom: 'aakk', amount: '100000000000000000000' },
            },
          ],
          memo: '7c3e147b9f7e91175fbc634a3e52c76349a976db@192.168.0.1:26656',
          timeout_height: '0',
          extension_options: [],
        ...
        signatures: ['KzX5/y7xyfTOIfI0C7qhxdOEDKqjBfl1voO3cdfexFV7dG99dbrlHYFViBN/EOed9+iQOnY0Ar3frnn3hiNC+gA='],
      };
...

        {
          ...
          if (commonNode > 0) {
            for (let i = 0; i < nodesCount; i++) {
              ...
              genesis.app_state.genutil.gen_txs = genesis.app_state.genutil.gen_txs.slice(0, validators);
